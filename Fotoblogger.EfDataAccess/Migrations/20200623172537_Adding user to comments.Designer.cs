...
namespace Fotoblogger.EfDataAccess.Migrations
{
    ...
    [Migration("20200623172537_Adding user to comments")]
    partial class Addingusertocomments
    {
            ...
            modelBuilder.Entity("Fotoblogger.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2020, 6, 23, 19, 25, 36, 494, DateTimeKind.Local).AddTicks(8348),
                            CreatedBy = 0,
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Administrator"
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2020, 6, 23, 19, 25, 36, 498, DateTimeKind.Local).AddTicks(924),
                            CreatedBy = 0,
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Moderator"
                        ...
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2020, 6, 23, 19, 25, 36, 498, DateTimeKind.Local).AddTicks(973),
                            CreatedBy = 0,
                            IsActive = true,
                            IsDeleted = false,
                            Name = "User"
            ...
            modelBuilder.Entity("Fotoblogger.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2020, 6, 23, 19, 25, 36, 499, DateTimeKind.Local).AddTicks(8890),
                            CreatedBy = 0,
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2020, 6, 23, 19, 25, 36, 500, DateTimeKind.Local).AddTicks(1758),
                            CreatedBy = 0,
                        ...
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2020, 6, 23, 19, 25, 36, 500, DateTimeKind.Local).AddTicks(1836),
                            CreatedBy = 0,

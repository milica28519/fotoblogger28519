...
namespace Fotoblogger.EfDataAccess.Migrations
{
    ...
    [Migration("20200627214032_Added new UseCase Create Role")]
    partial class AddednewUseCaseCreateRole
    {
            ...
            modelBuilder.Entity("Fotoblogger.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2020, 6, 27, 23, 40, 31, 727, DateTimeKind.Local).AddTicks(6083),
                            CreatedBy = 0,
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Administrator"
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2020, 6, 27, 23, 40, 31, 730, DateTimeKind.Local).AddTicks(9612),
                            CreatedBy = 0,
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Moderator"
                        ...
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2020, 6, 27, 23, 40, 31, 730, DateTimeKind.Local).AddTicks(9673),
                            CreatedBy = 0,
                            IsActive = true,
                            IsDeleted = false,
                            Name = "User"
            ...
            modelBuilder.Entity("Fotoblogger.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2020, 6, 27, 23, 40, 31, 731, DateTimeKind.Local).AddTicks(3931),
                            CreatedBy = 0,
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2020, 6, 27, 23, 40, 31, 731, DateTimeKind.Local).AddTicks(8332),
                            CreatedBy = 0,
                        ...
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2020, 6, 27, 23, 40, 31, 731, DateTimeKind.Local).AddTicks(8409),
                            CreatedBy = 0,

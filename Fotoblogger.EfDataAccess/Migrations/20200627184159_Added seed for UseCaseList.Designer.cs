...
namespace Fotoblogger.EfDataAccess.Migrations
{
    ...
    [Migration("20200627184159_Added seed for UseCaseList")]
    partial class AddedseedforUseCaseList
    {
            ...
            modelBuilder.Entity("Fotoblogger.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2020, 6, 27, 20, 41, 58, 372, DateTimeKind.Local).AddTicks(3176),
                            CreatedBy = 0,
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Administrator"
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2020, 6, 27, 20, 41, 58, 375, DateTimeKind.Local).AddTicks(5996),
                            CreatedBy = 0,
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Moderator"
                        ...
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2020, 6, 27, 20, 41, 58, 375, DateTimeKind.Local).AddTicks(6060),
                            CreatedBy = 0,
                            IsActive = true,
                            IsDeleted = false,
                            Name = "User"
            ...
            modelBuilder.Entity("Fotoblogger.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2020, 6, 27, 20, 41, 58, 375, DateTimeKind.Local).AddTicks(8156),
                            CreatedBy = 0,
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2020, 6, 27, 20, 41, 58, 376, DateTimeKind.Local).AddTicks(1171),
                            CreatedBy = 0,
                        ...
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2020, 6, 27, 20, 41, 58, 376, DateTimeKind.Local).AddTicks(1240),
                            CreatedBy = 0,

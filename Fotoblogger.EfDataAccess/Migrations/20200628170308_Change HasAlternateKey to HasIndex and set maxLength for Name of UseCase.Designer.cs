...
namespace Fotoblogger.EfDataAccess.Migrations
{
    ...
    [Migration("20200628170308_Change HasAlternateKey to HasIndex and set maxLength for Name of UseCase")]
    partial class ChangeHasAlternateKeytoHasIndexandsetmaxLengthforNameofUseCase
    {
            ...
            modelBuilder.Entity("Fotoblogger.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2020, 6, 28, 19, 3, 7, 712, DateTimeKind.Local).AddTicks(4689),
                            CreatedBy = 0,
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Administrator"
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2020, 6, 28, 19, 3, 7, 716, DateTimeKind.Local).AddTicks(1552),
                            CreatedBy = 0,
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Moderator"
                        ...
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2020, 6, 28, 19, 3, 7, 716, DateTimeKind.Local).AddTicks(1629),
                            CreatedBy = 0,
                            IsActive = true,
                            IsDeleted = false,
                            Name = "User"
            ...
            modelBuilder.Entity("Fotoblogger.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2020, 6, 28, 19, 3, 7, 716, DateTimeKind.Local).AddTicks(4230),
                            CreatedBy = 0,
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2020, 6, 28, 19, 3, 7, 716, DateTimeKind.Local).AddTicks(8409),
                            CreatedBy = 0,
                        ...
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2020, 6, 28, 19, 3, 7, 716, DateTimeKind.Local).AddTicks(8528),
                            CreatedBy = 0,

...
namespace Fotoblogger.EfDataAccess.Migrations
{
    ...
    [Migration("20200629104802_Added property IsMaster to entity Role and property UseCaseId to entity UseCaseLog")]
    partial class AddedpropertyIsMastertoentityRoleandpropertyUseCaseIdtoentityUseCaseLog
    {
            ...
            modelBuilder.Entity("Fotoblogger.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2020, 6, 29, 12, 48, 1, 541, DateTimeKind.Local).AddTicks(4926),
                            CreatedBy = 0,
                            IsActive = true,
                            IsDeleted = false,
                            IsMaster = true,
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2020, 6, 29, 12, 48, 1, 545, DateTimeKind.Local).AddTicks(362),
                            CreatedBy = 0,
                            IsActive = true,
                            IsDeleted = false,
                            IsMaster = false,
                        ...
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2020, 6, 29, 12, 48, 1, 545, DateTimeKind.Local).AddTicks(423),
                            CreatedBy = 0,
                            IsActive = true,
                            IsDeleted = false,
                            IsMaster = false,
            ...
            modelBuilder.Entity("Fotoblogger.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2020, 6, 29, 12, 48, 1, 545, DateTimeKind.Local).AddTicks(2452),
                            CreatedBy = 0,
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2020, 6, 29, 12, 48, 1, 545, DateTimeKind.Local).AddTicks(6438),
                            CreatedBy = 0,
                        ...
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2020, 6, 29, 12, 48, 1, 545, DateTimeKind.Local).AddTicks(6541),
                            CreatedBy = 0,

...
namespace Fotoblogger.EfDataAccess.Migrations
{
    ...
    [Migration("20200625180114_Renamed property of path to fileName for photos")]
    partial class RenamedpropertyofpathtofileNameforphotos
    {
            ...
            modelBuilder.Entity("Fotoblogger.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2020, 6, 25, 20, 1, 13, 707, DateTimeKind.Local).AddTicks(9429),
                            CreatedBy = 0,
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Administrator"
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2020, 6, 25, 20, 1, 13, 711, DateTimeKind.Local).AddTicks(1470),
                            CreatedBy = 0,
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Moderator"
                        ...
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2020, 6, 25, 20, 1, 13, 711, DateTimeKind.Local).AddTicks(1526),
                            CreatedBy = 0,
                            IsActive = true,
                            IsDeleted = false,
                            Name = "User"
            ...
            modelBuilder.Entity("Fotoblogger.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2020, 6, 25, 20, 1, 13, 712, DateTimeKind.Local).AddTicks(9230),
                            CreatedBy = 0,
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2020, 6, 25, 20, 1, 13, 713, DateTimeKind.Local).AddTicks(2295),
                            CreatedBy = 0,
                        ...
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2020, 6, 25, 20, 1, 13, 713, DateTimeKind.Local).AddTicks(2393),
                            CreatedBy = 0,

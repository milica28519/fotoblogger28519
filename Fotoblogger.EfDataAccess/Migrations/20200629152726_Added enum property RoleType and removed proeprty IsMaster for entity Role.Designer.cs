...
namespace Fotoblogger.EfDataAccess.Migrations
{
    ...
    [Migration("20200629152726_Added enum property RoleType and removed proeprty IsMaster for entity Role")]
    partial class AddedenumpropertyRoleTypeandremovedproeprtyIsMasterforentityRole
    {
            ...
            modelBuilder.Entity("Fotoblogger.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2020, 6, 29, 17, 27, 26, 97, DateTimeKind.Local).AddTicks(3007),
                            CreatedBy = 0,
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Administrator",
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2020, 6, 29, 17, 27, 26, 101, DateTimeKind.Local).AddTicks(440),
                            CreatedBy = 0,
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Moderator",
                        ...
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2020, 6, 29, 17, 27, 26, 101, DateTimeKind.Local).AddTicks(528),
                            CreatedBy = 0,
                            IsActive = true,
                            IsDeleted = false,
                            Name = "User",
            ...
            modelBuilder.Entity("Fotoblogger.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2020, 6, 29, 17, 27, 26, 101, DateTimeKind.Local).AddTicks(3501),
                            CreatedBy = 0,
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2020, 6, 29, 17, 27, 26, 101, DateTimeKind.Local).AddTicks(6501),
                            CreatedBy = 0,
                        ...
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2020, 6, 29, 17, 27, 26, 101, DateTimeKind.Local).AddTicks(6593),
                            CreatedBy = 0,

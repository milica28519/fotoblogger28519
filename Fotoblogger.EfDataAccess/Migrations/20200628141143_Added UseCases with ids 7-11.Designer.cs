...
namespace Fotoblogger.EfDataAccess.Migrations
{
    ...
    [Migration("20200628141143_Added UseCases with ids 7-11")]
    partial class AddedUseCaseswithids711
    {
            ...
            modelBuilder.Entity("Fotoblogger.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2020, 6, 28, 16, 11, 42, 664, DateTimeKind.Local).AddTicks(5615),
                            CreatedBy = 0,
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Administrator"
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2020, 6, 28, 16, 11, 42, 668, DateTimeKind.Local).AddTicks(3641),
                            CreatedBy = 0,
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Moderator"
                        ...
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2020, 6, 28, 16, 11, 42, 668, DateTimeKind.Local).AddTicks(3703),
                            CreatedBy = 0,
                            IsActive = true,
                            IsDeleted = false,
                            Name = "User"
            ...
            modelBuilder.Entity("Fotoblogger.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2020, 6, 28, 16, 11, 42, 668, DateTimeKind.Local).AddTicks(5930),
                            CreatedBy = 0,
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2020, 6, 28, 16, 11, 42, 669, DateTimeKind.Local).AddTicks(85),
                            CreatedBy = 0,
                        ...
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2020, 6, 28, 16, 11, 42, 669, DateTimeKind.Local).AddTicks(182),
                            CreatedBy = 0,

...
namespace Fotoblogger.EfDataAccess.Migrations
{
    ...
    [Migration("20200625221017_Added property Posts to User")]
    partial class AddedpropertyPoststoUser
    {
            ...
            modelBuilder.Entity("Fotoblogger.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2020, 6, 26, 0, 10, 16, 513, DateTimeKind.Local).AddTicks(797),
                            CreatedBy = 0,
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Administrator"
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2020, 6, 26, 0, 10, 16, 516, DateTimeKind.Local).AddTicks(2925),
                            CreatedBy = 0,
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Moderator"
                        ...
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2020, 6, 26, 0, 10, 16, 516, DateTimeKind.Local).AddTicks(2979),
                            CreatedBy = 0,
                            IsActive = true,
                            IsDeleted = false,
                            Name = "User"
            ...
            modelBuilder.Entity("Fotoblogger.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2020, 6, 26, 0, 10, 16, 518, DateTimeKind.Local).AddTicks(177),
                            CreatedBy = 0,
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2020, 6, 26, 0, 10, 16, 518, DateTimeKind.Local).AddTicks(3191),
                            CreatedBy = 0,
                        ...
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2020, 6, 26, 0, 10, 16, 518, DateTimeKind.Local).AddTicks(3266),
                            CreatedBy = 0,

...
namespace Fotoblogger.EfDataAccess.Migrations
{
    ...
    [Migration("20200627175618_Store UseCases in DB")]
    partial class StoreUseCasesinDB
    {
            ...
            modelBuilder.Entity("Fotoblogger.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2020, 6, 27, 19, 56, 18, 51, DateTimeKind.Local).AddTicks(3733),
                            CreatedBy = 0,
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Administrator"
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2020, 6, 27, 19, 56, 18, 56, DateTimeKind.Local).AddTicks(151),
                            CreatedBy = 0,
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Moderator"
                        ...
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2020, 6, 27, 19, 56, 18, 56, DateTimeKind.Local).AddTicks(316),
                            CreatedBy = 0,
                            IsActive = true,
                            IsDeleted = false,
                            Name = "User"
            ...
            modelBuilder.Entity("Fotoblogger.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2020, 6, 27, 19, 56, 18, 58, DateTimeKind.Local).AddTicks(3597),
                            CreatedBy = 0,
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2020, 6, 27, 19, 56, 18, 58, DateTimeKind.Local).AddTicks(7814),
                            CreatedBy = 0,
                        ...
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2020, 6, 27, 19, 56, 18, 58, DateTimeKind.Local).AddTicks(7932),
                            CreatedBy = 0,

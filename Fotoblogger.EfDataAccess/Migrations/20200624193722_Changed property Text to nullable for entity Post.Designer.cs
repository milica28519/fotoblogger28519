...
namespace Fotoblogger.EfDataAccess.Migrations
{
    ...
    [Migration("20200624193722_Changed property Text to nullable for entity Post")]
    partial class ChangedpropertyTexttonullableforentityPost
    {
            ...
            modelBuilder.Entity("Fotoblogger.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2020, 6, 24, 21, 37, 21, 787, DateTimeKind.Local).AddTicks(7480),
                            CreatedBy = 0,
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Administrator"
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2020, 6, 24, 21, 37, 21, 790, DateTimeKind.Local).AddTicks(9301),
                            CreatedBy = 0,
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Moderator"
                        ...
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2020, 6, 24, 21, 37, 21, 790, DateTimeKind.Local).AddTicks(9352),
                            CreatedBy = 0,
                            IsActive = true,
                            IsDeleted = false,
                            Name = "User"
            ...
            modelBuilder.Entity("Fotoblogger.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2020, 6, 24, 21, 37, 21, 792, DateTimeKind.Local).AddTicks(6607),
                            CreatedBy = 0,
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2020, 6, 24, 21, 37, 21, 792, DateTimeKind.Local).AddTicks(9516),
                            CreatedBy = 0,
                        ...
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2020, 6, 24, 21, 37, 21, 792, DateTimeKind.Local).AddTicks(9590),
                            CreatedBy = 0,

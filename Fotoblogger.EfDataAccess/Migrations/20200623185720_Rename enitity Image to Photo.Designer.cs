...
namespace Fotoblogger.EfDataAccess.Migrations
{
    ...
    [Migration("20200623185720_Rename enitity Image to Photo")]
    partial class RenameenitityImagetoPhoto
    {
            ...
            modelBuilder.Entity("Fotoblogger.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2020, 6, 23, 20, 57, 19, 975, DateTimeKind.Local).AddTicks(322),
                            CreatedBy = 0,
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Administrator"
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2020, 6, 23, 20, 57, 19, 978, DateTimeKind.Local).AddTicks(1859),
                            CreatedBy = 0,
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Moderator"
                        ...
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2020, 6, 23, 20, 57, 19, 978, DateTimeKind.Local).AddTicks(1912),
                            CreatedBy = 0,
                            IsActive = true,
                            IsDeleted = false,
                            Name = "User"
            ...
            modelBuilder.Entity("Fotoblogger.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2020, 6, 23, 20, 57, 19, 979, DateTimeKind.Local).AddTicks(9108),
                            CreatedBy = 0,
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2020, 6, 23, 20, 57, 19, 980, DateTimeKind.Local).AddTicks(2408),
                            CreatedBy = 0,
                        ...
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2020, 6, 23, 20, 57, 19, 980, DateTimeKind.Local).AddTicks(2506),
                            CreatedBy = 0,

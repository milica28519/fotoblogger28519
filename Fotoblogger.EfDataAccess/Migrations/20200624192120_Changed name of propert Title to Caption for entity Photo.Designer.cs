...
namespace Fotoblogger.EfDataAccess.Migrations
{
    ...
    [Migration("20200624192120_Changed name of propert Title to Caption for entity Photo")]
    partial class ChangednameofpropertTitletoCaptionforentityPhoto
    {
            ...
            modelBuilder.Entity("Fotoblogger.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2020, 6, 24, 21, 21, 20, 349, DateTimeKind.Local).AddTicks(6971),
                            CreatedBy = 0,
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Administrator"
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2020, 6, 24, 21, 21, 20, 352, DateTimeKind.Local).AddTicks(9090),
                            CreatedBy = 0,
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Moderator"
                        ...
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2020, 6, 24, 21, 21, 20, 352, DateTimeKind.Local).AddTicks(9141),
                            CreatedBy = 0,
                            IsActive = true,
                            IsDeleted = false,
                            Name = "User"
            ...
            modelBuilder.Entity("Fotoblogger.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2020, 6, 24, 21, 21, 20, 354, DateTimeKind.Local).AddTicks(6733),
                            CreatedBy = 0,
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2020, 6, 24, 21, 21, 20, 355, DateTimeKind.Local).AddTicks(2),
                            CreatedBy = 0,
                        ...
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2020, 6, 24, 21, 21, 20, 355, DateTimeKind.Local).AddTicks(89),
                            CreatedBy = 0,
